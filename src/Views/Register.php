<?php
session_start();
$erro = $_SESSION['register_erro'] ?? null;
...
<body class="h-full flex items-center justify-center bg-gray-100 dark:bg-gray-900">
  ...
  <div class="w-full max-w-md bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md">
    ...
    <form method="POST" action="/register" class="space-y-5">
      ...
      <div>
        <label for="confirm_password" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Confirmar Senha</label>
      ...
      <button>
        <a href="/login" class="w-full text-center block bg-gray-200 hover:bg-gray-300 text-gray-800 py-2.5 px-4 rounded-lg transition font-medium">
          Já tenho uma conta
        </a> 
        </div>
    </form>
